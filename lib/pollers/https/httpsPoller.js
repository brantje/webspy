 ...
 * @api   public
 */
function HttpsPoller(target, timeout, callback,check) {
  this.check = check;
  HttpsPoller.super_.call(this, target, timeout, callback,check);
}
